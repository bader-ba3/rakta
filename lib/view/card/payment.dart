            ...
            children: [
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), border: Border.all(color: Colors.black), color: selected == i ? Colors.blueAccent : Colors.grey.shade200),
                      child: Row(
                        children: [
                          SizedBox(
                            width: 10,
                          ...
                          Center(
                              child: Text(
                            i.toString() + " AED",
                            style: TextStyle(fontWeight: selected == i ? FontWeight.bold : FontWeight.normal, color: selected == i ? Colors.white : Colors.black),
                          )),
                          Spacer(),
                        ],
                      ),
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        "get 10% balance if you charge your card with more than 100 AED on April",
              ...
              Center(
                child: Padding(
                  ...
                  child: StatefulBuilder(builder: (context, appleSetState) {
                    return Center(
                      child: Padding(
